 ...
 * private val liveDataObserver: Observer<String> = mock()
 *
 * @Test
 * fun `functionName - given state - emits value via live data`() {
 *
 *     sut.actionableDialogEvent.observe(lifecycleOwner, liveDataObserver)
 *     sut.functionName("Some Data")
 *
 *     // Start the lifecycle event after observing live data
 *     lifecycleOwner.start()
 *
 *     verify(liveDataObserver, times(1)).onChanged("Result Data")
 * }
 * ```
 */
