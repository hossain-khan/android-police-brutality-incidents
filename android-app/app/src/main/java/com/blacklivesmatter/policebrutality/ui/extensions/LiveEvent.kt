 ...
 *
 * ```
 * viewModel.singleEventData.observe(this, Observer { eventData ->
 *      // Use the event data to navigate to screen or show single toast/snackbar message
 * });
 * ```
 *
 * Source:
 ...
 */
class LiveEvent<T> constructor() : MediatorLiveData<T>() {
